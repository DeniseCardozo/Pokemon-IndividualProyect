    ...
    <React.Fragment>
      <div className={styles.contents}>
        ...
        <div className={styles.boxerror}>
          {errors.nameInput && (
            <p className={styles.error}>{errors.nameInput}</p>
          )}
        </div>
        <div className={styles.textPokedex}>
          <h4 className={styles.text}>
            You can search for pokemons by typing their name!.
            <span>&#160;</span>
          </h4>
        </div>
        <div className={styles.boxFilterbutton}>
          <div className={styles.filterButton}>
            <h1 className={styles.filterButtontext} onClick={handleClic}>
              FILTERS
            </h1>
          </div>
          <h5 className={styles.text2}>
            Use the filters to better find your pokemon.
          </h5>
        </div>
        {showFilters ? (
